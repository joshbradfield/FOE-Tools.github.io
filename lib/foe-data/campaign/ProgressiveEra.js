...
module.exports = {
    ...
    sectors: [
      {
        ...
        cost: [
          { key: "basalt", value: 50, type: bonus.good },
          { key: "tar", value: 25, type: bonus.good }
        ]
      },
      {
        reward: [{ type: "supply", value: 5000 }],
        cost: [
          { key: "silk", value: 60, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "coin", value: 7000 }],
        cost: [
          { key: "brass", value: 60, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "supply", value: 5000 }],
        cost: [
          { key: "gunpowder", value: 60, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "coin", value: 7000 }],
        cost: [
          { key: "talc_powder", value: 60, type: bonus.good },
          { key: "porcelain", value: 25, type: bonus.good }
        ]
      }
    ]
  },
  Uxrow: {
    key: "Uxrow",
    reward: [
      { type: "coin", value: 75000 },
      { type: "supply", value: 25000 }
    ],
    sectors: [
      {
  ...
  Omoien: {
    key: "Omoien",
    reward: [
      { type: "coin", value: 70000 },
      { type: "supply", value: 70000 }
    ],
    sectors: [
      {
        reward: [{ type: "coin", value: 7000 }],
  ...
  Ostrand: {
    key: "Ostrand",
    reward: [
      { type: "coin", value: 90000 },
      { type: "supply", value: 50000 }
    ],
    sectors: [
      {
        reward: [{ type: "supply", value: 7500 }],
