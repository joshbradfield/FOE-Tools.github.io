...
module.exports = {
  ...
  NewCragshire: {
    key: "NewCragshire",
    reward: [
      { type: "coin", value: 40000 },
      { type: "supply", value: 40000 }
    ],
    sectors: [
      {
    ...
    sectors: [
      {
        reward: [{ type: "supply", value: 4000 }],
        cost: [
          { key: "wire", value: 85, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "supply", value: 4000 }],
        cost: [
          { key: "tar", value: 85, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "supply", value: 4000 }],
        cost: [
          { key: "coffee", value: 85, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "coin", value: 4000 }],
        cost: [
          { key: "porcelain", value: 85, type: bonus.good },
      ...
      },
      {
        reward: [{ type: "coin", value: 4000 }],
        cost: [
          { key: "paper", value: 85, type: bonus.good },
  ...
  Ydine: {
    ...
    reward: [
      ...
      { type: "supply", value: 100000 },
      { type: "medal", value: 200 }
    ],
    sectors: [
      {
        reward: [{ type: "coin", value: 4000 }],
